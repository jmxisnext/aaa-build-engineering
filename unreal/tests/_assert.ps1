...
# Copied from dashboard/tests/_assert.ps1 to keep the unreal track's tests isolated
# in its own subdir (CLAUDE.md scope contract) rather than cross-sourcing dashboard.

...
- Subdirs added per track as work progresses: `perforce/`, `ci/`, `accel/`, `unreal/`, `pipeline/` (`pipeline/` — Track 5; slice 1, the content cooker / mini DDC-CAS, landed; C# WPF tool + CI wiring still to come).

...
- Keep tracks isolated in their subdir (`perforce/`, `ci/`, `accel/`, `unreal/`, `pipeline/`; `pipeline/` is Track 5 — slice 1 (content cooker) landed, WPF tool + CI wiring still to come). Don't let one track's work bleed into another's.
